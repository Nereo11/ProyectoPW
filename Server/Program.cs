...
//Servicio EntityFrameWork
builder.Services.AddDbContext<BDProveedoresContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
